        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Your trusted online grocery store in New Delhi. Fresh products delivered to your doorstep in minutes.
            </p>
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-blinkit-green transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/products" className="text-gray-400 hover:text-white transition-colors text-sm">Shop All Products</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li className="flex items-center gap-2">
                ...
                <span>support@familymart.in</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              ...
              <Link to="/returns" className="text-gray-400 hover:text-white text-sm transition-colors">Returns</Link>
            </div>
          </div>
        </div>
      </div>
